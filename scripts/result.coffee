...
unless args.length >= 2
  console.error 'Usage: pnpm result <problem> <number> [date]  (e.g. pnpm result a 1  or  pnpm result a 1 20260418)'
  process.exit 1
...
dest = join qDir, dateDir, 'mock', problem, "#{num}._result.txt"
